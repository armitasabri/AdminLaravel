          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Auth::user()->name }}                  <small>مدیریت کل سایت</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('admin.profile')}}"><i class="fa fa-circle-o"></i> داشبرد اول</a></li>
            <li><a href="{{route('admin.profile2')}}"><i class="fa fa-circle-o"></i> داشبرد دوم</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{asset('app-assets/pages/layout/boxed.htm')}}l"><i class="fa fa-circle-o"></i> باکس ها</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.chartjs')}}"><i class="fa fa-circle-o"></i>نمودار ChartJS</a></li>
