    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset ('app-assets/pages/layout/top-nav.html')}}"><i class="fa fa-circle-o"></i> نوار بالا</a></li>
            <li><a href="{{asset ('app-assets/pages/layout/boxed.html')}}"><i class="fa fa-circle-o"></i> باکس ها</a></li>
            <li><a href="{{asset ('app-assets/pages/layout/fixed.html')}}"><i class="fa fa-circle-o"></i> فیکس شده</a></li>
            <li><a href="{{asset ('app-assets/pages/layout/collapsed-sidebar.html')}}"><i class="fa fa-circle-o"></i> سایدبار</a></li>
          </ul>
        </li>
        <li>
          <a href="{{asset ('app-assets/pages/widgets.html')}}">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset ('app-assets/pages/charts/chartjs.html')}}"><i class="fa fa-circle-o"></i>نمودار ChartJS</a></li>
            <li><a href="{{asset ('app-assets/pages/charts/morris.html')}}"><i class="fa fa-circle-o"></i>نمودار Morris</a></li>
            <li><a href="{{asset ('app-assets/pages/charts/flot.html')}}"><i class="fa fa-circle-o"></i>نمودار Flot</a></li>
            <li><a href="{{asset ('app-assets/pages/charts/inline.html')}}"><i class="fa fa-circle-o"></i>نمودار Inline charts</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset ('app-assets/pages/UI/general.html')}}"><i class="fa fa-circle-o"></i> عمومی</a></li>
            <li><a href="{{asset ('app-assets/pages/UI/icons.html')}}"><i class="fa fa-circle-o"></i> آیکون</a></li>
            <li><a href="{{asset ('app-assets/pages/UI/buttons.html')}}"><i class="fa fa-circle-o"></i> دکمه</a></li>
            <li><a href="{{asset ('app-assets/pages/UI/sliders.html')}}"><i class="fa fa-circle-o"></i> اسلایدر</a></li>
            <li><a href="{{asset ('app-assets/pages/UI/timeline.html')}}"><i class="fa fa-circle-o"></i> تایم لاین</a></li>
            <li><a href="{{asset ('app-assets/pages/UI/modals.html')}}"><i class="fa fa-circle-o"></i> مدال</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset ('app-assets/pages/forms/general.html')}}"><i class="fa fa-circle-o"></i> اجزای عمومی</a></li>
            <li><a href="{{asset ('app-assets/pages/forms/advanced.html')}}"><i class="fa fa-circle-o"></i> پیشرفته</a></li>
            <li><a href="{{asset ('app-assets/pages/forms/editors.html')}}"><i class="fa fa-circle-o"></i> ویرایشگر</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset ('app-assets/pages/tables/simple.html')}}"><i class="fa fa-circle-o"></i> جدول ساده</a></li>
            <li><a href="{{asset ('app-assets/pages/tables/data.html')}}"><i class="fa fa-circle-o"></i> جدول داده</a></li>
          </ul>
        </li>
        <li>
          <a href="{{asset ('app-assets/pages/calendar.html')}}">
        ...
        <li>
          <a href="{{asset ('app-assets/pages/mailbox/mailbox.html')}}">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset ('app-assets/pages/examples/invoice.html')}}"><i class="fa fa-circle-o"></i> سفارش</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/profile.html')}}"><i class="fa fa-circle-o"></i> پروفایل</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/login.html')}}"><i class="fa fa-circle-o"></i> صفحه ورود</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/register.html')}}"><i class="fa fa-circle-o"></i> ثبت نام</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/lockscreen.html')}}"><i class="fa fa-circle-o"></i> قفل صفحه</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/404.html')}}"><i class="fa fa-circle-o"></i> ارور ۴۰۴</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/500.html')}}"><i class="fa fa-circle-o"></i> ارور ۵۰۰</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/blank.html')}}"><i class="fa fa-circle-o"></i> صفحه خالی</a></li>
            <li><a href="{{asset ('app-assets/pages/examples/pace.html')}}"><i class="fa fa-circle-o"></i> صفحه سریع</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="{{asset ('app-assets/dist/img/user1-128x128.jpg')}}" alt="message user image">
                      <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="{{asset ('app-assets/dist/img/user3-128x128.jpg')}}" alt="message user image">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset ('app-assets/dist/img/user1-128x128.jpg')}}" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset ('app-assets/dist/img/user7-128x128.jpg')}}" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset ('app-assets/dist/img/user3-128x128.jpg')}}" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset ('app-assets/dist/img/user5-128x128.jpg')}}" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset ('app-assets/dist/img/user6-128x128.jpg')}}" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset ('app-assets/dist/img/user8-128x128.jpg')}}" alt="User Image">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      <img src="{{asset ('app-assets/dist/img/user1-128x128.jpg')}}" alt="User Image">
                      <a class="users-list-name" href="#">الکساندر گراهامبل</a>
                      <span class="users-list-date">امروز</span>
                    </li>
                    <li>
                      <img src="{{asset ('app-assets/dist/img/user8-128x128.jpg')}}" alt="User Image">
                      <a class="users-list-name" href="#">نیوتن</a>
                      <span class="users-list-date">دیروز</span>
                    </li>
                    <li>
                      <img src="{{asset ('app-assets/dist/img/user7-128x128.jpg')}}" alt="User Image">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="{{asset ('app-assets/pages/examples/invoice.html')}}">OR9842</a></td>
                    <td>آیفون ۵</td>
                  ...
                  <tr>
                    <td><a href="{{asset ('app-assets/pages/examples/invoice.html')}}">OR1848</a></td>
                    <td>سامسونگ ۶</td>
                  ...
                  <tr>
                    <td><a href="{{asset ('app-assets/pages/examples/invoice.html')}}">OR7429</a></td>
                    <td>آیفون ۶</td>
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="{{asset ('app-assets/dist/img/default-50x50.gif')}}" alt="Product Image">
                  </div>
